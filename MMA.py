...
This file has been modified by Enrico Stragiotti (ONERA) to add the external move limit "extmove" (cfr. Verbart 2017).
"""
...
def mmasub(m,n,iter,xval,xmin,xmax,xold1,xold2,f0val,df0dx,fval,dfdx,low,upp,a0,a,c,d):
    ...
    # Adding the External move limit extmove (cfr. Verbart 2017)
    if iter <= 2:
        ...
        lowmin = xval-extmove*(xmax-xmin)
        lowmax = xval-0.01*extmove*(xmax-xmin)
        uppmin = xval+0.01*extmove*(xmax-xmin)
        uppmax = xval+extmove*(xmax-xmin)
